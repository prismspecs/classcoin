...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "haha";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "CLCN";
    ...
    const std::string daemonName = "ClassCoind";

    /* The name to call this wallet */
    const std::string walletName = "classwallet";

    /* The name of service/walletd, the programmatic rpc interface to a
       wallet */
    const std::string walletdName = "classcoin-service";
